...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Verificando se as vendas ultrapassaram as metas

        // Se vendas mensais forem maiores ou iguais à meta mensal
        if ($vendas_mensais >= $meta_mensal) {
            ...
            // Se não atingir a meta mensal, não terá bônus
      ...
      // Verifica se os valores inseridos fazem sentido na lógica de que vendas mensais sera sempre > que vendas semanais
      if ($vendas_semanais < $vendas_mensais) {
        ...
        //  Se não, exibe uma mensagem de erro se os valores não fizerem sentido conforme a lógica feita na condição.
        echo "<h2>Erro:</h2>";
        echo "<p>O valor das vendas mensais deve ser maior que o valor das vendas semanais.</p>";
    }
}
?>
</body>
